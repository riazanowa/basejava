...
public class ResumeTestData {
    ...
    public static Resume createResume(String uuid, String fullName) {
        ...
        List<ExperienceStage> educationStages = Arrays.asList(
                new ExperienceStage("Coursera", new Link("https://www.coursera.org/course/progfun"), Collections.singletonList(new Period(LocalDate.of(2013, Month.MARCH, 1), LocalDate.of(2013, Month.MAY, 1), "", "Functional Programming Principles in Scala' by Martin Odersky"))),
                new ExperienceStage("Luxoft", new Link("http://www.luxoft-training.ru/training/catalog/course.html?ID=22366"), Collections.singletonList(new Period(LocalDate.of(2011, Month.MARCH, 1), LocalDate.of(2011, Month.APRIL, 1), "", "Курс 'Объектно-ориентированный анализ ИС. Концептуальное моделирование на UML.'"))),
                new ExperienceStage("Siemens AG", new Link("http://www.luxoft-training.ru/training/catalog/course.html?ID=22366"), Collections.singletonList(new Period(LocalDate.of(2005, Month.JANUARY, 1), LocalDate.of(2005, Month.APRIL, 1), "", "3 месяца обучения мобильным IN сетям (Берлин)"))),
                new ExperienceStage("Alcatel", new Link("http://www.siemens.ru/"), Collections.singletonList(new Period(LocalDate.of(1997, Month.SEPTEMBER, 1), LocalDate.of(1998, Month.MARCH, 1), "", "6 месяцев обучения цифровым телефонным сетям (Москва)"))),
                new ExperienceStage("Санкт-Петербургский национальный исследовательский университет информационных технологий, механики и оптики", new Link("http://www.ifmo.ru/"),
                ...
                new ExperienceStage("Заочная физико-техническая школа при МФТИ", new Link("http://www.school.mipt.ru/"), Collections.singletonList(new Period(LocalDate.of(1984, Month.APRIL, 1), LocalDate.of(1987, Month.MARCH, 1), "", "Закончил с отличием")))
        );
